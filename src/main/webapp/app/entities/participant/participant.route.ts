...
import {MembresResolve} from "app/entities/membres/membres.route";
...
export const participantRoute: Routes = [
  {
    ...
    data: {
      ...
      pageTitle: 'gestionApp.participant.home.title'
    },
  ...
  {
    path: 'tache/add/:idTache',
    component: ParticipantTacheAddComponent,
    resolve: {
