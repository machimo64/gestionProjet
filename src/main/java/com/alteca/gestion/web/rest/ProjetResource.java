...
public class ProjetResource {
    ...
    public ProjetResource(ProjetRepository projetRepository, MembresRepository membresRepository, UserRepository userRepository) {
    ...
    public ResponseEntity<Projet> createProjet(@Valid @RequestBody Projet projet) throws URISyntaxException {
        ...
        //On ajoue les autres admins en tant que membre du projet
