...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select user from User user where user.id not in (select membres.user.id from Membres membres where membres.projet.id = :idProjet)")
    List<User> findByNotProjet(@Param("idProjet") Long idProjet);
